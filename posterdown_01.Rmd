...
The complete package, including the cleaned data, code and the poster template is at (https://github.com/yadbor/EPSM-analysis), or just scan the QR code on this poster.