...
When EPSM came to Perth in 2013, for various reasons it looked like making a huge loss.

To save money the branch members did most of the work of handling submissions, scheduling and making the abstract book. 
...
SUBS[, sum := cumsum(n[order(days)]), by=conference]
